        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((image, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end">
                {" "}
